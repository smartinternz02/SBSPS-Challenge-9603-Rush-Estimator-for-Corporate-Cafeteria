...
from datasaver import LogData,writecsv
...
if not True:
    cap = cv.VideoCapture('Test Files/example_01.mp4')
    h = 480/1.5
    w = 640
else:
...
def saveData():
    print("Called")
    global data
    logD.WriteData(time.strftime("%c") ,data)
                ...
                for i in persons:
                    ...
                    if abs(x-i.getX()) <= w and abs(y-i.getY()) <= h:
                        ...
                        if i.going_UP(line_down,line_up) == True:
                            ...
                            data['Out'] = data['Out']+1
                            print(data['Out'])
                            writecsv([data['id'],time.strftime("%c"),data['In'],data['Out']])

                            log.write("ID: "+str(i.getId())+' crossed going out at ' + time.strftime("%c") + '\n')
                            ...
                            log.write("ID: " + str(i.getId()) + ' crossed going in at ' + time.strftime("%c") + '\n')
                        break
